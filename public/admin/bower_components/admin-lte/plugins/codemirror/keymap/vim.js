...
(function(mod) {
  ...
  var Vim = function() {
    ...
    * in the right place.
    ...
    // Translates a search string from ex (vim) syntax into javascript form.blade.php.
    ...
    // javascript form.blade.php.  Similar to translateRegex, but additionally fixes back references
    ...
    function parseQuery(query, ignoreCase, smartCase) {
      ...
      // the regex string in the form.blade.php /regex/flags
    ...
    var exCommands = {
      ...
      global: function(cm, params) {
        // a global command is of the form.blade.php
        // :[range]g/pattern/[cmd]
      ...
      substitute: function(cm, params) {
        ...
        if (tokens.length) {
          ...
          // either the argString is empty or its of the form.blade.php ' hello/world'
          // actually splitBySlash returns a list of tokens
          // only if the string starts with a '/'
          if (argString && argString.length) {
            showConfirm(cm, 'Substitutions should be of the form.blade.php ' +
                ':s/pattern/replace/');
            return;
          }
        }
